...
import { 
  ...
  Saludar, showLoading, fechaLocal, // Función para mostrar saludos/mensajes
  Notificacion, Mensaje, // Sistema de notificaciones y mensajes
  savels, getls, removels, // Funciones para localStorage
  gosave, getsave, gosaves, getsaves, // Funciones avanzadas de almacenamiento
  openModal, closeModal, closeAllModals, // Sistema de ventanas modales
  Capi
} from './widev.js';
