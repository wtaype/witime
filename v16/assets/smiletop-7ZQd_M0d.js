import{o as g,l as h,$ as i,m as y,M as n,n as $,p as w,G as e,h as d,j as u,k as m,H as A,B as S,I as C}from"./widev-p-w4NLbQ.js";g(h,async r=>{r?U():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(h),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(r){console.error(r)}});async function U(r){const b=`
